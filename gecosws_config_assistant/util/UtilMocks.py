...
class GecosCC(object):
    ...
    def get_computer_names(self, data):
        ...
        return [{"node_chef_id": "a48b2f532c009e1d328cfa83c923ee58", "name": "testgecos3"}]
    
    def search_ou_by_text(self, data, searchFilter):
        self.logger.debug('Search ou by text...')
        return [["5566df5f1d5e265de2047434", "users"], ["5566df6d1d5e265de2047436", "computers"], ["5566df7b1d5e265ddcb59a63", "groups"], ["5566df4f1d5e265ddcb59a61", "pruebas.es"]]
