...
if 'check' in sys.argv:
    ...
    print "==> Loading mocks..."
    from gecosws_config_assistant.view.ViewMocks import showerror_gtk, AutoSetupDialog, AutoSetupProcessView, ADSetupDataElemView, ConnectWithGecosCCDialog
    ...
    from gecosws_config_assistant.view.AutoSetupProcessView import AutoSetupProcessView
